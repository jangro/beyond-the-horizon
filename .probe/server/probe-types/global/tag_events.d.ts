...
function tags(extra: "botania:brews", handler: (event: TagEventProbe<(Special.BrewsTag), (Special.Brews)>) => void): void
...
function tags(extra: "aether:advancement_sound_override", handler: (event: TagEventProbe<(Special.AdvancementSoundOverrideTag), (Special.AdvancementSoundOverride)>) => void): void
function tags(extra: "aether:moa_type", handler: (event: TagEventProbe<(Special.MoaTypeTag), (Special.MoaType)>) => void): void
...
function tags(extra: "lithostitched:modifier_predicate_type", handler: (event: TagEventProbe<(Special.ModifierPredicateTypeTag), (Special.ModifierPredicateType)>) => void): void
function tags(extra: "lithostitched:modifier_type", handler: (event: TagEventProbe<(Special.ModifierTypeTag), (Special.ModifierType)>) => void): void
function tags(extra: "rats:rat_variant", handler: (event: TagEventProbe<(Special.RatVariantTag), (Special.RatVariant)>) => void): void
...
function tags(extra: "forbidden_arcanus:hephaestus_forge/input", handler: (event: TagEventProbe<(Special.HephaestusForgeInputTag), (Special.HephaestusForgeInput)>) => void): void
function tags(extra: "dragonmounts:dragon_breeds", handler: (event: TagEventProbe<(Special.DragonBreedsTag), (Special.DragonBreeds)>) => void): void
...
function tags(extra: "forbidden_arcanus:hephaestus_forge/ritual", handler: (event: TagEventProbe<(Special.HephaestusForgeRitualTag), (Special.HephaestusForgeRitual)>) => void): void
...
function tags(extra: "paraglider:bargain_types", handler: (event: TagEventProbe<(Special.BargainTypesTag), (Special.BargainTypes)>) => void): void
...
function tags(extra: "forbidden_arcanus:enhancer/definition", handler: (event: TagEventProbe<(Special.EnhancerDefinitionTag), (Special.EnhancerDefinition)>) => void): void

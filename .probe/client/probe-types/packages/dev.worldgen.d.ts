...
declare module "packages/dev/worldgen/lithostitched/worldgen/feature/config/$DungeonFeatureConfig" {
...
export class $DungeonFeatureConfig extends $Record implements $FeatureConfiguration {
static readonly "CODEC": $Codec<($DungeonFeatureConfig)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $DungeonFeatureConfig$Type = ($DungeonFeatureConfig);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $DungeonFeatureConfig_ = $DungeonFeatureConfig$Type;
}}
...
export interface $StructurePoolAccess {
 ...
 "getLithostitchedTemplates"(): $ShufflingList<($StructurePoolElement)>
 "setLithostitchedTemplates"(arg0: $ShufflingList$Type<($StructurePoolElement$Type)>): void
}
...
import {$DungeonFeatureConfig, $DungeonFeatureConfig$Type} from "packages/dev/worldgen/lithostitched/worldgen/feature/config/$DungeonFeatureConfig"
...
export class $DungeonFeature extends $Feature<($DungeonFeatureConfig)> {
...
constructor(arg0: $Codec$Type<($DungeonFeatureConfig$Type)>)

public "place"(arg0: $FeaturePlaceContext$Type<($DungeonFeatureConfig$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
import {$UnderwaterMagmaConfiguration, $UnderwaterMagmaConfiguration$Type} from "packages/net/minecraft/world/level/levelgen/feature/configurations/$UnderwaterMagmaConfiguration"
import {$RandomPatchConfiguration, $RandomPatchConfiguration$Type} from "packages/net/minecraft/world/level/levelgen/feature/configurations/$RandomPatchConfiguration"
import {$WellFeatureConfig, $WellFeatureConfig$Type} from "packages/dev/worldgen/lithostitched/worldgen/feature/config/$WellFeatureConfig"
import {$ProbabilityFeatureConfiguration, $ProbabilityFeatureConfiguration$Type} from "packages/net/minecraft/world/level/levelgen/feature/configurations/$ProbabilityFeatureConfiguration"
import {$Codec, $Codec$Type} from "packages/com/mojang/serialization/$Codec"
import {$TreeConfiguration, $TreeConfiguration$Type} from "packages/net/minecraft/world/level/levelgen/feature/configurations/$TreeConfiguration"
import {$TwistingVinesConfig, $TwistingVinesConfig$Type} from "packages/net/minecraft/world/level/levelgen/feature/configurations/$TwistingVinesConfig"
...
export class $WellFeature extends $Feature<($WellFeatureConfig)> {
static readonly "NO_OP": $Feature<($NoneFeatureConfiguration)>
static readonly "TREE": $Feature<($TreeConfiguration)>
static readonly "FLOWER": $Feature<($RandomPatchConfiguration)>
static readonly "NO_BONEMEAL_FLOWER": $Feature<($RandomPatchConfiguration)>
...
constructor(arg0: $Codec$Type<($WellFeatureConfig$Type)>)

public "place"(arg0: $FeaturePlaceContext$Type<($WellFeatureConfig$Type)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
declare module "packages/dev/worldgen/lithostitched/worldgen/feature/config/$WellFeatureConfig" {
import {$Record, $Record$Type} from "packages/java/lang/$Record"
import {$BlockStateProvider, $BlockStateProvider$Type} from "packages/net/minecraft/world/level/levelgen/feature/stateproviders/$BlockStateProvider"
import {$ConfiguredFeature, $ConfiguredFeature$Type} from "packages/net/minecraft/world/level/levelgen/feature/$ConfiguredFeature"
import {$Stream, $Stream$Type} from "packages/java/util/stream/$Stream"
...
export class $WellFeatureConfig extends $Record implements $FeatureConfiguration {
static readonly "CODEC": $Codec<($WellFeatureConfig)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $WellFeatureConfig$Type = ($WellFeatureConfig);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $WellFeatureConfig_ = $WellFeatureConfig$Type;
}}

...
let desert_map = Item.of('quark:pathfinders_quill', '{targetBiome:"minecraft:desert",targetBiomeColor:8381695,targetBiomeUnderground:0b}');
let flower_forest_map = Item.of('quark:pathfinders_quill', '{targetBiome:"minecraft:flower_forest",targetBiomeColor:ffff00,targetBiomeUnderground:0b}');
...
let lush_caves_map = Item.of('quark:pathfinders_quill', '{targetBiome:"minecraft:lush_caves",targetBiomeColor:ccff66,targetBiomeUnderground:0b}');
